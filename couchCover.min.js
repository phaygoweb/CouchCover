(function(){var c={version:"0.0.1",init:function(a){for(var b in a)c.hasOwnProperty(b)||(c[b]=a[b])},xhr:function(a,b,e){var d=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");if(!d)return!1;a.url=c.host+"/"+a.url;if(!a.method)a.method="GET";d.onreadystatechange=function(){if(d.readyState===4){if(d.status===200)if(e)e(d);else return d}else return!1};d.open(a.method,a.url,!0);(a.method==="PUT"||a.method==="POST")&&d.setRequestHeader("Content-Type","application/json");
...
b(a.getResponseHeader("Etag").replace(/"/gi,""))})}};c.login=function(){};c.logout=function(){};window.couchCover=window.cc$=c;console.log("CouchCover "+c.version+" initialized")})(window);